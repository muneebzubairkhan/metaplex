      ...
      <div className='container mb-5 mb-md-2 mb-lg-5'>
        <div className='row justify-content-center'>
          <div className='col-md-6 col-lg-4 px-5'>
            <img src='http://localhost:3000/images/logo.png' className='w-100 mt-5' alt='' />
          </div>
          ...
          <div className='col-lg-8 col-md-10 col-12  mt-5'>
            <div className='row site__box'>
              <div className='col-lg-7 col-md-7 p-4 p-lg-5 siteBox__left d-flex flex-column align-items-center'>
                <img className='moonbird-logo' src='http://localhost:3000/images/moonbird-official-pfp.png' alt='' />
              ...
              <div className='col-lg-5 col-md-5 p-4 p-lg-5 d-flex flex-column align-items-center justify-content-between siteBox__right'>
                <div className='header-svg'>
                  <svg viewBox='0 0 116 94' fill='none' xmlns='http://www.w3.org/2000/svg' className='w-28 shape-crisp-edges ml-3'>
                    ...
                    <path d='M78 14h-2v2h2v-2ZM106 34h-2v2h2v-2ZM108 36h-2v2h2v-2Z' fill='#366B39'></path>
                    <path d='M112 36h-2v2h2v-2ZM114 38h-2v2h2v-2Z' fill='#539453'></path>
                    <path d='M74 48h-2v2h2v-2ZM76 48h-2v2h2v-2Z' fill='#366B39'></path>
                    ...
                    <path
                      ...
                      fill='#4E8B53'
                    ></path>
                    <path d='M16 70h-2v2h2v-2ZM18 70h-2v2h2v-2Z' fill='#366B39'></path>
                    <path d='M20 70h-2v2h2v-2ZM10 72H8v2h2v-2Z' fill='#539453'></path>
                    <path d='M12 72h-2v2h2v-2ZM14 72h-2v2h2v-2Z' fill='#366B39'></path>
                    <path d='M16 72h-2v2h2v-2Z' fill='#539453'></path>
                    <path d='M10 74H8v2h2v-2Z' fill='#366B39'></path>
                    <path d='M12 74h-2v2h2v-2ZM8 76H6v2h2v-2Z' fill='#539453'></path>
                    <path
                    ...
                    <path
                      ...
                      fill='#3D2723'
                    ></path>
                    <path d='M76 40v-2h-2v-2h-4v-2h-2v4h2v2h2v2h2v2h2v-2h2v-2h-2ZM96 40h-2v2h2v-2Z' fill='#3D2723'></path>
                    <path
                    ...
                    <path
                      ...
                      fill='#3D2723'
                    ></path>
                    <path d='M20 64v2h2v-4h-2v-4h-2v2h-2v2h2v2h2ZM68 64h4v-2h-6v2h2ZM78 62h-2v2h2v-2ZM74 64h-2v2h2v-2Z' fill='#3D2723'></path>
                    <path
                      ...
                      fill='#3D2723'
                    ></path>
                    <path d='M60 84v-2h-8v-2h-2v-2h-4v2h-4v2h-6v-2h-8v-2h-2v-2h-2v2h-2v2h4v2h8v2h6v2h24v-2h-4Zm-12 0v-2h2v2h-2Z' fill='#3D2723'></path>
                    <path
                      opacity='0.3'
                ...
                <div className='siteBoxLeft__bottom text-center  w-100'>
                  ...
                  <button className='btn-purple mt-3 w-100'>FIND YOUR SOLMOONBIRD</button>
                </div>
              </div>
            </div>
          </div>
